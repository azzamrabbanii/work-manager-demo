...
class MainActivity : AppCompatActivity() {
    ...
    private fun setOneTimeWorkRequest() {
        ...
        // constraint di gunakan untuk syarat worker akan berjalan apbila
        // constraint terpenuhi
        val constraints = Constraints.Builder() // builder ini untuk memangil class yg berada di contraints
        // hp akan berjalan jika HP dalam keadaan ngecharge dan terhubung internet
            .setRequiredNetworkType(NetworkType.CONNECTED)
            .setRequiresCharging(true)
            .build()

        // membuat input kedalam worker UploaderWorker
        ...
        // mengirimkan work request ke system
        workManager.enqueue(uploadRequest)

        // mendapatkan statues work manager
